...
const roles = [
  ...
  },
  {
    ...
    btnClass: "bg-gradient-to-r from-violet-500 to-blue-500 hover:from-violet-600 hover:to-blue-600 text-white shadow-lg shadow-violet-500/25",
    checkColor: "text-blue-500",
    testIdSignup: "button-landlord-signup",
    testIdLogin: "button-landlord-login",
  },
  {
    title: "Tenant",
    description: "View your unit and submit requests",
    icon: Users,
    signupLink: "/tenant-signup",
    loginLink: "/login",
    ...
    btnClass: "bg-gradient-to-r from-violet-500 to-blue-500 hover:from-violet-600 hover:to-blue-600 text-white shadow-lg shadow-violet-500/25",
    checkColor: "text-blue-500",
    testIdSignup: "button-tenant-signup",
    testIdLogin: "button-tenant-login",
  },
  {
    title: "Contractor",
