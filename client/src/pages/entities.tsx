            ...
            <div className="flex items-center space-x-4">
              ...
              <Dialog open={showEntityForm} onOpenChange={handleOpenChange}>
                <DialogTrigger asChild>
                  <Button data-testid="button-add-entity" className="bg-emerald-500 hover:bg-emerald-600 text-white shadow-lg shadow-emerald-300/40">
          ...
          {entitiesLoading ? (
            ...
            <Card className="rounded-2xl overflow-hidden" style={{
              ...
              <CardContent className="p-12 text-center">
                ...
                <Button onClick={() => setShowEntityForm(true)} data-testid="button-create-first-entity" className="bg-emerald-500 hover:bg-emerald-600 text-white shadow-lg shadow-emerald-300/40">
                  <Plus className="h-4 w-4 mr-2" />
                  Create First Entity
                </Button>
              </CardContent>
