...
import { z } from "zod";
import { Settings2, DollarSign, Clock, Shield, Save, Loader2 } from "lucide-react";
...
export function HubSettingsView() {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 overflow-y-auto">
      <div>
        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">Approval Settings</h2>
