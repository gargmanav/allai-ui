...
import { Users, Plus, Mail, Phone, FileText, DollarSign, Calendar, AlertTriangle, Archive, RotateCcw, Trash2, Pencil, RefreshCw } from "lucide-react";
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <div className={`w-12 h-12 rounded-lg flex items-center justify-center cursor-default ${
                            getTenantStatus(group, groupLeases) === "Current" ? "bg-green-100" :
                            getTenantStatus(group, groupLeases) === "Archived" ? "bg-gray-100" : "bg-orange-100"
                          }`}>
                            <Users className={`h-6 w-6 ${
                              getTenantStatus(group, groupLeases) === "Current" ? "text-green-600" :
                              getTenantStatus(group, groupLeases) === "Archived" ? "text-gray-500" : "text-orange-600"
                            }`} />
                          </div>
                        </TooltipTrigger>
                        <TooltipContent><p>{getTenantStatus(group, groupLeases)}</p></TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                    <div>
